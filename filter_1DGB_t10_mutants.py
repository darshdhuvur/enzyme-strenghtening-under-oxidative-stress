...
RAW_OUTPUT_FILE = "deconvolute_top10_raw.csv"
FINAL_SUMMARY_FILE = "deconvolute_top10_summary.csv"
THREADS_TO_USE = 5
N_STRUCT = 1
...
if __name__ == "__main__":
    ...
    mutations = ["A5S", "M9L", "A21P", "V32I", "K35A", "V38S", "T40R", "T55L", "V96A", "E116G"]
    ...
    print(f"Starting Top 10 Screen.")
    ...
    if len(job_queue) > 0:
        with multiprocessing.Pool(processes=THREADS_TO_USE) as pool:
            for result in tqdm(pool.imap_unordered(perform_mutation_task, job_queue), total=len(job_queue), desc="Processing Mutants"):
